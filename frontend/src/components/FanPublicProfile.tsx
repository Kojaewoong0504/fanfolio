...
export function FanPublicProfile({ userId, onBack, onOpenArtist, onOpenCollection, onTrade, initialCollection }: Props) {
  ...
  const fallbackImage = (event: SyntheticEvent<HTMLImageElement>) => { event.currentTarget.onerror = null; event.currentTarget.src = avatarFallback }
