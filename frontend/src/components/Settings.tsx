...
export function Settings({ user, onUserUpdated, onLogout }: { user: CurrentUser, onUserUpdated: (user: CurrentUser) => void, onLogout: () => Promise<void> }) {
...
function SettingIcon({ name }: { name: 'profile' | 'favorites' | 'account' | 'notifications' | 'language' | 'support' | 'legal' | 'info' }) {
  const paths = {
